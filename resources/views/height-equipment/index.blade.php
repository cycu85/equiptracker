                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm" role="group">
                                    <a href="{{ route('height-equipment.show', $equipment) }}" class="btn btn-outline-info" title="Podgląd">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('height-equipment.edit', $equipment) }}" class="btn btn-outline-primary" title="Edytuj">
