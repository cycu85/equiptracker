...
@section('title', 'Dodaj zestaw sprzętu wysokościowego')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="fas fa-plus"></i> Dodaj nowy zestaw sprzętu wysokościowego</h2>
...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('height-equipment-sets.store') }}">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('code') is-invalid @enderror" 
                                   id="code" name="code" value="{{ old('code') }}" placeholder="np. SWY-001">
                            @error('code')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('height-equipment-sets.index') }}" class="btn btn-secondary me-2">Anuluj</a>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-info mt-3">
                    <small><i class="fas fa-lightbulb"></i> Możesz dodawać sprzęt do zestawu klikając przycisk "Dodaj sprzęt".</small>
                </div>

                <div class="alert alert-warning mt-3">
                    <small><i class="fas fa-exclamation-triangle"></i> Pamiętaj o regularnym sprawdzaniu certyfikatów sprzętu wysokościowego!</small>
                </div>
            </div>
        </div>
    </div>
